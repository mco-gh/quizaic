...
# **quizzes_id_results_get**
> [Results] quizzes_id_results_get(id)

Returns a list of results objects for a specific quiz
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Returns a list of results objects for a specific quiz
        api_response = api_instance.quizzes_id_results_get(id)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling DefaultApi->quizzes_id_results_get: %s\n" % e)
```
...
# **quizzes_id_results_id2_delete**
> quizzes_id_results_id2_delete(id, id2)

deletes a results object for a specific quiz/player combination
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = default_api.DefaultApi(api_client)
    id = "id_example" # str | Quiz Id
    id2 = "id2_example" # str | Player Id

    # example passing only required values which don't have defaults set
    try:
        # deletes a results object for a specific quiz/player combination
        api_instance.quizzes_id_results_id2_delete(id, id2)
    except openapi_client.ApiException as e:
        print("Exception when calling DefaultApi->quizzes_id_results_id2_delete: %s\n" % e)
```
...
# **quizzes_id_results_id2_get**
> Results quizzes_id_results_id2_get(id, id2)

returns a single results object for a specific quiz/player combination
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # returns a single results object for a specific quiz/player combination
        api_response = api_instance.quizzes_id_results_id2_get(id, id2)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling DefaultApi->quizzes_id_results_id2_get: %s\n" % e)
```
...
# **quizzes_id_results_id2_patch**
> Results quizzes_id_results_id2_patch(id, id2, results)

updates results for a specific quiz/player combination
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    results = Results(
        ...
        responses=[],
    ) # Results | JSON representation of a results object

    # example passing only required values which don't have defaults set
    try:
        # updates results for a specific quiz/player combination
        api_response = api_instance.quizzes_id_results_id2_patch(id, id2, results)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling DefaultApi->quizzes_id_results_id2_patch: %s\n" % e)
```
 ...
 **id** | **str**| Quiz Id |
 **id2** | **str**| Player Id |
 **results** | [**Results**](Results.md)| JSON representation of a results object |
...
# **quizzes_id_results_post**
> Results quizzes_id_results_post(id, results)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Register a player for a quiz
        api_response = api_instance.quizzes_id_results_post(id, results)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling DefaultApi->quizzes_id_results_post: %s\n" % e)
```
