...
class Cause(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            description (str): the purpose of the cause. [optional] if omitted the server will use the default value of "no description"  # noqa: E501
            image_url (str, none_type): location of image to display for the cause. [optional]  # noqa: E501
            active (bool): is this cause accepting donations at this time?. [optional] if omitted the server will use the default value of False  # noqa: E501
