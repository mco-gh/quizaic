...
class Donation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, campaign, donor, amount, *args, **kwargs):  # noqa: E501
        """Donation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, campaign, donor, amount, *args, **kwargs):  # noqa: E501
        """Donation - a model defined in OpenAPI
