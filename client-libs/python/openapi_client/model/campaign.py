...
class Campaign(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'managers': ([str],),  # noqa: E501
            'goal': (float,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, cause, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            description (str): the purpose of the campaign. [optional] if omitted the server will use the default value of "no description"  # noqa: E501
            managers ([str]): [optional] if omitted the server will use the default value of []  # noqa: E501
            goal (float): the fundraising goal, in USD. [optional] if omitted the server will use the default value of 0  # noqa: E501
            image_url (str, none_type): location of image to display for the campaign. [optional]  # noqa: E501
            active (bool): is this campaign accepting donations at this time?. [optional] if omitted the server will use the default value of False  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, cause, *args, **kwargs):  # noqa: E501
        """Campaign - a model defined in OpenAPI
