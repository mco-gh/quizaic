...
class Donor(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "email", "id", "mailing_address", "timeCreated", "updated", "selfLink", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "email", "id", "mailing_address", "timeCreated", "updated", "selfLink", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        mailing_address: typing.Union[MetaOapg.properties.mailing_address, None, str, schemas.Unset] = schemas.unset,
