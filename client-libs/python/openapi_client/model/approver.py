...
class Approver(ModelNormal):
    ...
    def _from_openapi_data(cls, email, *args, **kwargs):  # noqa: E501
        """Approver - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str, none_type): the display name of this Approver. [optional]  # noqa: E501
            active (bool): is this approver currently active?. [optional] if omitted the server will use the default value of False  # noqa: E501
